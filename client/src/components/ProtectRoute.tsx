...
function ProtectRoute(props: any) {
    ...
    if (!state.loading && state.user && location.pathname.match(/(regiser|login)/gi)) {
        return <Navigate to='/dashboard' />;
    }

    //If the user is not logged in and they try to visit a user related page, take them to the log in page
