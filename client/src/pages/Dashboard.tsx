                ...
                <section className="d-grid gap-4 pet-output">
                    {petData && petData.getUserPets.map((pet: Pet) => (
                        <article key={pet._id} className="border p-4">
                            <h4>Type: {pet.name}</h4>
                            <p>Age: {pet.age}</p>
                            <Button variant="primary" className="me-2" onClick={() => handleShow(pet)}>Create Post</Button>
                            <Button variant="secondary" className="me-2">View Post</Button>
                        ...
                        <Form>
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control
                                    name="title"
                                    type="text"
                                    placeholder="Enter the tile of your post"
                                    autoFocus
